...
<div class="mbt-photo-field-wrapper">
    ...
    <div class="mbt-img-container<?php if ( $has_img  ) { echo ' mbt-has-img'; } ?>">
        <?php if ( $has_img ) : ?>
    ...
    <div class="mbt-img-input">
        <input type="text" id="<?php echo $id; ?>[url]" name="<?php echo $id; ?>[url]" class="mbt-img-url <?php echo $class; ?>" value="<?php echo $img_url; ?>" />
        <div class="mbt-img-action">
            <!-- Add & remove image buttons -->
            <p class="hide-if-no-js">
                <a class="button mbt-upload-img <?php if ( $has_img  ) { echo 'hidden'; } ?>"
                   href="<?php echo $upload_link ?>">
                    <?php echo ( isset( $field['text'] ) && isset( $field['text']['upload'] ) ) ? $field['text']['upload'] : esc_html__('Upload Photo', 'mbt'); ?>
                </a>
                <a class="mbt-delete-img <?php if ( ! $has_img  ) { echo 'hidden'; } ?>"
